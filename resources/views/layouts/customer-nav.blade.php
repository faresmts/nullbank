...
<ul class="space-y-2 font-medium">
    <li>
        <a href=" {{ route('customers.transactions.index', $customer->cpf) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 {{ request()->routeIs('customers.transactions.*') ? 'bg-gray-100' : '' }} dark:hover:bg-gray-700 group hover:scale-105 transition-transform duration-300" wire:navigate>

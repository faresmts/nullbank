                    ...
                    <div
                        ...
                        <div class="flex-1 flex items-center space-x-2">
                            <h5>
                                ...
                                <span class="dark:text-white">{{ Transacao::allFromAgency($agency->id)->count() }}</span>
                            </h5>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            <form action=" {{ route('banktellers.transactions.index', $bankteller->id) }}" class="flex items-center">
                            ...
                            @if(request()->has('search'))
                                <a href=" {{ route('banktellers.transactions.index', $bankteller->id) }}"
        ...
        <div id="createModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form method="POST" action="{{ route('banktellers.transactions.store', $bankteller->id) }}">
                        @csrf

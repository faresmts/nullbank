        ...
        <div
            ...
            <form method="POST" action="{{ route('accounts.update', $account->id) }}">
                    ...
                    <div class="mb-5">
                        ...
                        <select id="cpf" name="cpf"
                            ...
                            @foreach($customers as $customer)
                                <option
                                    value="{{$customer->cpf}}" {{ $customer->cpf == $accountCustomersIds[0] ? 'selected' : ''}}>{{$customer->nome}} {{ $customer->sobrenome }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="agencia_id" name="agencia_id"
                            ...
                            @foreach($agencies as $agency)
                                <option
                                    value="{{$agency->id}}" {{$agency->id == $account->agencia_id ? 'selected' : ''}}>{{$agency->nome}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <select id="gerente_id" name="gerente_id"
                            ...
                            @foreach($managers as $manager)
                                <option
                                    value="{{$manager->id}}" {{$manager->id == $account->gerente_id ? 'selected' : ''}}>{{$manager->nome}} {{$manager->sobrenome}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="flex flex-row items-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                    <a href=" {{ route('accounts.index') }}" type="button"

                    ...
                    <div
                        ...
                        <div class="flex-1 flex items-center space-x-2">
                            <h5>
                                ...
                                <span class="dark:text-white">{{ Conta::allFromManager($manager->id)->count() }}</span>
                            </h5>
                        </div>
                    </div>
                    <div
                        ...
                        <div class="w-full md:w-1/2">
                            <form action=" {{ route('managers.accounts.index', $manager->id) }}" class="flex items-center">
                            ...
                            @if(request()->has('search'))
                                <a href=" {{ route('managers.accounts.index', $manager->id)  }}"
                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            <a href=" {{ route('managers.accounts.edit', [$manager->id, $account->id]) }}"
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="p-6 text-center">
                                                        ...
                                                        <div class="flex items-center gap-3 justify-center">
                                                            <form method="POST"
                                                                  action="{{ route('managers.accounts.destroy', [$manager->id, $account->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button
                                                                    data-modal-toggle="delete-modal-{{ $account->id }}"
        ...
        <div id="createModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <!-- Modal body -->
                    <form method="POST" action="{{ route('managers.accounts.store', $manager->id) }}">
                        @csrf
                        <div class="grid grid-cols-2 gap-5 justify-center">
                            ...
                            <div class="mb-5">
                                ...
                                <input readonly type="text" id="gerente_id" name="gerente_id"
                                       value="{{str_pad($manager->id, 5, '0', STR_PAD_LEFT) }}"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                       required>
                            </div>

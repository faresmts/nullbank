                                ...
                                <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <button type="button" data-modal-target="delete-modal-{{ $employee->id }}"
                                                    data-modal-toggle="delete-modal-{{ $employee->id }}"
                                            ...
                                            <!-- Delete Modal -->
                                            <div id="delete-modal-{{ $employee->id }}" tabindex="-1"
                                                        ...
                                                        <div class="p-6 text-center">
                                                            ...
                                                            <div class="flex items-center gap-3 justify-center">
                                                                <form method="POST" action="{{ route('employees.destroy', $employee->id) }}">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button data-modal-toggle="delete-modal-{{ $employee->id }}" type="submit"
                                                                            class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                                        Sim, tenho certeza.
                                                                    </button>
                                                                </form>

                                                                <button data-modal-toggle="delete-modal-{{ $employee->id }}" type="button"
                            ...
                            <div class="grid grid-cols-3 gap-8 max-w-screen-lg">
                                ...
                                <div>
                                    <div class="mb-5">
                                        ...
                                        <input type="number" id="cep" name="cep" minlength="7" maxlength="7" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="12345-678" required>
                                    </div>
